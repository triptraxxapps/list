...
public class WidgetConfigure extends Activity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ArrayAdapter<ShoppingList> adapter = new ArrayAdapter<ShoppingList>(this, android.R.layout.simple_spinner_dropdown_item, 0, lists);
    ...
    static String loadColorPref(Context context, int appWidgetId) {
        ...
        return prefs.getString(PREF_PREFIX_KEY_COLOR + appWidgetId, "white");
    }

    static long loadListPref(Context context, int appWidgetId) {
        SharedPreferences prefs = context.getSharedPreferences(PREFS_NAME, 0);
        return prefs.getLong(PREF_PREFIX_KEY_LIST + appWidgetId, 0);
    }
